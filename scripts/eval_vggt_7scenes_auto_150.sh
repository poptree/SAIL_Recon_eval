...
use_ba=false
baconfigs=baconfig/nerfacto_7scenes.json
benchmarking_environment="nerfstudio"
benchmarking_method="nerfacto"
benchmarking_split_folder="benchmark_datasets/7scenes"
benchmarking_out_dir="benchmark_output/vggt_multiba/7scenes_v6v4_30k_150_300"
out_dir="reconstructions/7scenes/v6v4_30k_150_300"
datasets_folder="benchmark_datasets/7scenes"
# scenes=("stairs" )

scenes=("office" "pumpkin" "redkitchen" "chess" "fire" "heads"  "stairs")
