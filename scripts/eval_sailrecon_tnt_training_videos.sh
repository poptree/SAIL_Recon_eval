...
benchmarking_out_dir="benchmark_output/sail-recon/tnt_training_videos"
out_dir="reconstructions/tnt_videos/"
...
for scene in ${scenes[*]}; do
    ...
    sailrecon_pose_file="${out_dir}/training__${scene}/pred.txt"
