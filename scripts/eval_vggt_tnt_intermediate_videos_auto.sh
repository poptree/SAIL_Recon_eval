...
benchmarking_out_dir="benchmark_output/vggt_ba_1e-31e-5_all_images/tnt_intermediate_videos"
out_dir="reconstructions/tnt_video_v6v3_30k_100_300"
datasets_folder="benchmark_datasets/tnt_intermediate_videos"
# scenes=("Barn" "Caterpillar" "Church" "Ignatius" "Meetingroom" "Truck")
scenes=("Family" "Francis" "Horse" "Lighthouse" "Playground" "Train" "M60" "Panther")
# scenes=( )
