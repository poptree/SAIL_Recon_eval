...
benchmarking_out_dir="benchmark_output/vggt_multiba/200_frames_v6v4_30k_50_300"
out_dir="reconstructions/7scenes_200/200_frames_v6v4_30k_50_300"
datasets_folder="benchmark_datasets/7scenes_subset"

scenes=("chess" "fire" "heads" "office" "pumpkin" "redkitchen" "stairs")
# scenes=("chess")

for scene in ${scenes[*]}; do
    input_rgb_files="${datasets_folder}/${scene}/*.color.png"
