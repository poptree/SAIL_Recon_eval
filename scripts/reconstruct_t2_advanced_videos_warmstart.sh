...
datasets_folder_sparse="datasets/t2_colmap/advanced"
# input folder with T2 video frames
datasets_folder_video="datasets/t2/advanced_videos"

# output directory for the reconstruction
out_dir="reconstructions/t2_advanced_videos_warmstart"
# target directory for benchmarking results
benchmarking_out_dir="benchmark/t2_advanced_videos_warmstart"
