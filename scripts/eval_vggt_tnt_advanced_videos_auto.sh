...
benchmarking_out_dir="benchmark_output/vggt_ba_1e-31e-4_all_images_8096/tnt_advanced_videos"
out_dir="reconstructions/tnt_video_v6v3_30k_100_300"
datasets_folder="benchmark_datasets/tnt_advanced_videos"
...
for scene in ${scenes[*]}; do
    ...
    output_ace_file="${out_dir}/advanced__${scene}/ace_pose.txt"
