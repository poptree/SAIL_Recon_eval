...
benchmarking_out_dir="benchmark_output/vggt_ba_1e-31e-5/mip360_v6v4_25k_50_300"
out_dir="reconstructions/mip360_v6v4_25k_50_300"
...
for scene in ${scenes[*]}; do
    ...
    if $run_benchmark; then
        ...
        python -m benchmarks.benchmark_poses --pose_file ${output_ace_file} --output_dir ${benchmarking_scene_dir} --images_glob_pattern "${input_rgb_files}" --split_json ${benchmarking_split_folder}/mip360_${scene}.json --method ${benchmarking_method} --camera_optimizer off --run_ba  2>&1 | tee ${benchmarking_out_dir}/log_${scene}.txt
    fi
done
